...
function handle_completion_insecurities() {
  ...
  ls -ld "${(@)insecure_dirs}"
  print '[gigish] For safety, we will not load completions from these directories until\n' \
...
function initialize {
  local zcompdump_revision zcompdump_refresh zcompdump_path
...
initialize && set_options && set_styles

unset -f initialize set_options set_styles handle_completion_insecurities
